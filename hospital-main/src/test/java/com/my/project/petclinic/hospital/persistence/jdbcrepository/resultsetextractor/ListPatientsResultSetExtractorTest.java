...
public class ListPatientsResultSetExtractorTest {
    @InjectMocks
    private ListPatientsResultSetExtractor subject;
    ...
    void shouldReturnDoctorWhenExtractDataTest() throws SQLException {
        ...
        //when
        final List<Patient> result = subject.extractData(rs);

        //then
        assertThat(result).isNotNull();
        assertThat(result.get(0)).extracting("id", "name", "surName", "age")
                .contains(5L, "patientName", "patientSurName", 35);
        assertThat(result.get(0).getDoctors()).hasSizeGreaterThan(0);
